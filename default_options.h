...
#define DROPBEAR_DEFPORT "65522"

/* Listen on all interfaces */
#define DROPBEAR_DEFADDRESS "127.0.0.22"

/* Default hostkey paths - these can be specified on the command line.
 * Homedir is prepended if path begins with ~/
 */
#define DSS_PRIV_FILENAME "/etc/smile/dss_host_key"
#define RSA_PRIV_FILENAME "/etc/smile/rsa_host_key"
#define ECDSA_PRIV_FILENAME "/etc/smile/ecdsa_host_key"
#define ED25519_PRIV_FILENAME "/etc/smile/ed25519_host_key"
